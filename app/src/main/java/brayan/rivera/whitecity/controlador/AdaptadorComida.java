...
public class AdaptadorComida extends RecyclerView.Adapter<AdaptadorComida.SitioViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final SitioViewHolder holder, final int position) {
        ...
        storageRef.child("fotos/" + comida.getImagenPath()).getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            @Override
